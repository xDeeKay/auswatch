    ...
    <>
      <div className="px-6 py-6">
        <main className="mx-auto flex max-w-5xl flex-col divide-y divide-parchment/10 [&>*+*]:mt-5 [&>*+*]:pt-5">
          <header>
            <h1 className="font-heading text-lg text-parchment">How to Spot a Camera</h1>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-parchment">By type</h2>
            <div className="flex flex-col gap-2 border-l-2 border-amber/40 pl-4">
              <p className="text-sm font-semibold text-parchment">CCTV Camera</p>
            ...
            <div className="flex flex-col gap-2 border-l-2 border-amber/40 pl-4">
              <p className="text-sm font-semibold text-parchment">Speed Camera</p>
              <p className="text-sm leading-relaxed text-parchment/70">
            ...
            <div className="flex flex-col gap-2 border-l-2 border-amber/40 pl-4">
              <p className="text-sm font-semibold text-parchment">ALPR / Plate Reader</p>
              <p className="text-sm leading-relaxed text-parchment/70">
            ...
            <div className="flex flex-col gap-2 border-l-2 border-amber/40 pl-4">
              <p className="text-sm font-semibold text-parchment">Facial Recognition</p>
              <p className="text-sm leading-relaxed text-parchment/70">
            ...
            <div className="flex flex-col gap-2 border-l-2 border-amber/40 pl-4">
              <p className="text-sm font-semibold text-parchment">Other</p>
              <p className="text-sm leading-relaxed text-parchment/70">
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-parchment">Before you submit</h2>
            <ul className="flex flex-col gap-2 text-sm leading-relaxed text-parchment/70">
