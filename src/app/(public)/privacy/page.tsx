    ...
    <>
      <div className="px-6 py-6">
        <main className="mx-auto flex max-w-5xl flex-col divide-y divide-foreground/10 [&>*+*]:mt-5 [&>*+*]:pt-5">
          <header>
            <h1 className="font-heading text-lg text-foreground">Privacy Policy</h1>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">If you submit a camera or correction</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">If you&rsquo;re a moderator or admin</h2>
            <p className="text-sm leading-relaxed text-foreground/70">
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">Cookies</h2>
            <p className="text-sm leading-relaxed text-foreground/70">
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">What we don&rsquo;t do</h2>
            <p className="text-sm leading-relaxed text-foreground/70">
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">Changes to this policy</h2>
            <p className="text-sm leading-relaxed text-foreground/70">
