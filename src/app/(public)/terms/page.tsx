    ...
    <>
      <div className="px-6 py-6">
        <main className="mx-auto flex max-w-5xl flex-col divide-y divide-foreground/10 [&>*+*]:mt-5 [&>*+*]:pt-5">
          <header>
            <h1 className="font-heading text-lg text-foreground">Terms of Service</h1>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">Submitting to AusWatch</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">The AusWatch dataset</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">Using the site itself</h2>
            <p className="text-sm leading-relaxed text-foreground/70">
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">What AusWatch doesn&rsquo;t do</h2>
            <p className="text-sm leading-relaxed text-foreground/70">
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">No warranty</h2>
            <p className="text-sm leading-relaxed text-foreground/70">
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-heading text-base text-foreground">Changes to these terms</h2>
            <p className="text-sm leading-relaxed text-foreground/70">
